...
import info.infiniteloops.discuss.chat.ui.*;
import info.infiniteloops.discuss.chat.ui.TVFragment;
...
public class MainActivity extends AppCompatActivity {
    ...
    public static String STR_MOVIE_FRAGMENT = "MOVIE";
    public static String STR_TV_FRAGMENT = "TV";
    ...
    private void setupTabIcons() {
        int[] tabIcons = {
                R.drawable.ic_movie_black_32dp,
                R.drawable.ic_tv_black_32dp,
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFrag(new MovieFragment(), STR_MOVIE_FRAGMENT);
        adapter.addFrag(new TVFragment(), STR_TV_FRAGMENT);
        ...
        floatButton.setOnClickListener(((FriendsFragment) adapter.getItem(3)).onClickFloatButton.getInstance(this));
...
//    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.about) {
            Toast.makeText(this, "MovieChat version 1.0", Toast.LENGTH_LONG).show();
            return true;
        }
