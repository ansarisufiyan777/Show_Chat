...
import info.infiniteloops.discuss.adapter.VideoAdapter;
...
public class VideosActivity extends AppCompatActivity {
    ...
    private static final String ARG_TYPE = "info.infiniteloops.discuss.video_type";
    private static final String ARG_ID = "info.infiniteloops.discuss.id";
