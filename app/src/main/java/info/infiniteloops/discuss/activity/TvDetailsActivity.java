...
import info.infiniteloops.discuss.service.TvService;
...
public class TvDetailsActivity extends AppCompatActivity {
    ...
    private static final String TV_ID = "info.infiniteloops.discuss.details.tv_id";
    ...
    void subscribe(){
        ...
        utilities.subscribedTV(this,tv);
    }
    @OnClick(R.id.talk)
    void talk(){
        Utilities utilities = new Utilities();
        utilities.checkGroupAvailablityAndOpenChat(tv,this);
