...
import info.infiniteloops.discuss.ShowChatContextWrapper;
...
import info.infiniteloops.discuss.model.Video;
import info.infiniteloops.discuss.model.VideoResults;
import info.infiniteloops.discuss.provider.MovieContract;
import info.infiniteloops.discuss.service.MovieService;
import info.infiniteloops.discuss.service.ServiceGenerator;
import info.infiniteloops.discuss.util.AppUtils;
import info.infiniteloops.discuss.util.Constants;
import info.infiniteloops.discuss.util.ContentValuesUtils;
...
public class MovieDetailsActivity extends AppCompatActivity {
    ...
    private static final String MOVIE_ID = "info.infiniteloops.discuss.details.movie_id";
    ...
    private void loadFromDb() {
        ...
        if (mCursor.moveToNext()) {
            ...
            movie.setOriginalTitle(originalNameStr);
            movie.setReleaseDate(releaseDateStr);
            movie.setId(mCursor.getString(mCursor.getColumnIndex(MovieContract.Movies.MOVIE_ID)));
            setTitle(nameStr);
    ...
    void subscribe(){
        ...
        utilities.subscribedMovie(this,movie);
    }
    @OnClick(R.id.talk)
    void talk(){
        Utilities utilities = new Utilities();
        utilities.checkGroupAvailablityAndOpenChat(movie,this);
    }
}
